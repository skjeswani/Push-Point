...
export const ThumbsUpIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className || "h-5 w-5"} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M14 10h4.764a2 2 0 011.789 2.894l-3.5 7A2 2 0 0115.263 21h-4.017c-.163 0-.326-.02-.485-.06L7 20m7-10V5a2 2 0 00-2-2h-.085a2 2 0 00-1.736.93L5.5 8m7 2v5m0 0v-5m0 5H9.828a2 2 0 01-1.789-2.894l3.5-7a2 2 0 011.789-1.106h4.017c.886 0 1.624.468 1.902 1.217l.065.183a2 2 0 01-1.39 2.6L18 12.556v.044c.59.31 1 .92 1 1.622 0 .828-.535 1.54-1.258 1.823l-.065.027a2 2 0 01-1.686-.337L14.5 15m-3 5H5m2-17v5m0 0v5m0-5h5.5" />
    </svg>
);

export const ThumbsDownIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className || "h-5 w-5"} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M10 14H5.236a2 2 0 01-1.789-2.894l3.5-7A2 2 0 018.738 3h4.017c.163 0 .326.02.485.06L17 4m-7 10v-5m0 5v5m0-5H8.172a2 2 0 01-1.789-2.894l3.5-7a2 2 0 011.789-1.106h4.017c.886 0 1.624.468 1.902 1.217l.065.183a2 2 0 01-1.39 2.6L16 11.444v.044c.59.31 1 .92 1 1.622 0 .828-.535 1.54-1.258 1.823l-.065.027a2 2 0 01-1.686-.337L10.5 17m3-5H19m-2-17v5m0 0v5m0-5h-5.5" />
    </svg>
);
...
export const GoogleIcon: React.FC<IconProps> = ({ className }) => (
	...
	C42.022,35.219,44,30.023,44,24C44,22.659,43.862,21.35,43.611,20.083z" />
    </svg>
);
